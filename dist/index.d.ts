...
declare const s: {
    ...
    onCollision: (spriteOne: Sprite, spriteTwo: Sprite, triggerOnceWhileTrue: boolean, callback: () => any) => number;
    onSpriteClicked: (sprite: Sprite, callback: (coords: {
        x: number;
        y: number;
    }) => any) => void;
...
export { Game, Sprite, onKeyDown, onKeyUp, onCollision, onSpriteClicked, onClick };
export default s;
